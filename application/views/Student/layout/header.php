...
<body>
	...
	<div class="top-bar_sub_w3layouts_agile">
		...
		<div class="search">
			<h5><a class="sign" href="<?php echo base_url('index.php/Studentcontroller/logout')?>">Student Logout</a></h5>
			...
			<div class="header-nav-agileits">
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="top_nav">
								<li><a href="<?php echo base_url('index.php/Studentcontroller/student_home')?>">Home</a></li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<!-- <li><a href="<?php echo base_url('index.php/Studentcontroller/seminar_topic')?>">Seminar Topic</a></li>subject_seminar -->
										<li><a href="<?php echo base_url('index.php/Studentcontroller/subject_seminar')?>">Seminar Topic</a></li>
										<li><a href="<?php echo base_url('index.php/Studentcontroller/manage_seminar')?>">Manage Seminar </a></li>
 ...
 -->
								...
								<li><a href="<?php echo base_url('index.php/Studentcontroller/subject_onlineclass')?>">Online Class</a></li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li><a href="<?php echo base_url('index.php/Studentcontroller/syllabus')?>">Syllabus</a></li>
										<li><a href="<?php echo base_url('index.php/Studentcontroller/subject_topic')?>">Topics Covered</a></li>
									</ul>
								</li>

									<li><a href="<?php echo base_url('index.php/Studentcontroller/seme_internal_timetable')?>">Timetable (Internal)</a></li>
								
								<!-- <li><a href="<?php echo base_url('index.php/Studentcontroller/timetable')?>">Timetable (Internal)</a></li> -->
								<li><a href="<?php echo base_url('index.php/Studentcontroller/semester_timetable')?>">Timetable (Semester)</a></li>
								
								
								<li><a href="<?php echo base_url('index.php/Studentcontroller/student_semester')?>">Internal mark</a></li>
								
								
								<li><a href="<?php echo base_url('index.php/Studentcontroller/student_profile')?>">My Profile</a></li>
								<li><a href="<?php echo base_url('index.php/Studentcontroller/student_leave')?>">My Leave History</a></li>
							</ul>
						</nav>
					</div>
				</nav>
