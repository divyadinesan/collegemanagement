		...
		<div class="container">
			...
			<div class="inner_sec_w3_agileinfo">
				...
				<div class="col-md-4 grid_info_main">
					<div class="grid_info">
						<div class="icon_info">
							<a href="<?php echo base_url('index.php/Studentcontroller/faculty_fetch/'.$sylbs->subject_id)?>"><img src="<?php echo base_url('Asset/Admin/subject/'.$sylbs->subject_image)?>" style="height: 150px;width: 150px"></a>
