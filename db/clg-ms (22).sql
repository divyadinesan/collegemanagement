...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2023 at 12:18 PM
...
(3, 1, 'S2', 3, '9.00am - 12.30pm', '2023-02-24'),
(4, 1, 'S2', 4, '9.00am - 12.30pm', '2023-02-21'),
(5, 1, 'S2', 9, '9.00am - 12.30pm', '2023-02-26');
...
--
ALTER TABLE `internal_mark`
  MODIFY `internal_mark_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `time_table`
  MODIFY `time_table_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
